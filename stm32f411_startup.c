...
/**Build:
main.o :  arm-none-eabi-gcc -c -mcpu=cortex-m4 -mthumb -std=gnu11 main.c -o
main.o stm32f411_startup.o : arm-none-eabi-gcc -c -mcpu=cortex-m4 -mthumb
-std=gnu11 stm32f411_startup.c -o stm32f411_startup.o stm32_blink.elf :
arm-none-eabi-gcc -nostdlib -T stm32_ls.ld *.o -o stm32_blink.elf
...
uint32_t vector_tbl[] __attribute__((section(".isr_vector_tbl"))) = {
    ...
    (uint32_t)&TAMP_STAMP_IRQHandler, /* Tamper and TimeStamp interrupts through
                                       */
    (uint32_t)&RTC_WKUP_IRQHandler,   /* RTC Wakeup interrupt through the EXTI
                                         line                         */
    ...
    (uint32_t)&TIM1_BRK_TIM9_IRQHandler, /* TIM1 Break interrupt and TIM9 global
                                            interrupt                     */
    (uint32_t)&TIM1_UP_TIM10_IRQHandler, /* TIM1 Update interrupt and TIM10
                                            global interrupt */
    (uint32_t)&TIM1_TRG_COM_TIM11_IRQHandler, /* TIM1 Trigger and Commutation
    ...
    (uint32_t)&RTC_Alarm_IRQHandler,   /* RTC Alarms (A and B) through EXTI line
                                          interrupt                   */
    (uint32_t)&OTG_FS_WKUP_IRQHandler, /* USB On-The-Go FS Wakeup through EXTI
                                          line interrupt                */
    0, /* Reserved                                                           */
    0, /* Reserved                                                           */
    0, /* Reserved                                                           */
...
void Reset_Handler(void) {
  ...
  for (uint32_t i = 0; i < (data_mem_size / 4); i++) {
